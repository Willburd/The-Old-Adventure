...
struct Actor* ACTOR_FACTORY(cJSON* file_data, ActorTypes actor_type, struct Actor* parent, Vector3 at_position, Quaternion at_rotation, Vector3 at_scale, Vector3 initial_velocity, Vector3 initial_angular_velocity);
