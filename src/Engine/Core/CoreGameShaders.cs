...
namespace Engine
{
    public partial class Core
    {
        ...
        private static void ApplyPrerenderEnvironmentUniforms(List<ShaderData.Uniform> vertex_uniforms, double tick_delta)
        {
            ...
            ApplyVertexUniforms(tick_delta, vertex_uniforms, light_pos, light_col, 1, Vector3.Zero, float.PositiveInfinity);
        }
        ...
        private static void ApplyEnvironmentUniforms(List<ShaderData.Uniform> vertex_uniforms, double tick_delta)
        {
            ...
            // Assemble uniforms
            ApplyVertexUniforms(tick_delta, vertex_uniforms, light_pos, light_col, light_count, fog_color, fog_distance);
        }
