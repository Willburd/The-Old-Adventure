namespace Engine
{
    public partial class Core
    {
        public enum Signals
        {
            ...
            link_components,       // () : Called after create during OnInit(). Allows for components to cache each other for quicker use. Done as it's own step to ensure all components have finished being added.
