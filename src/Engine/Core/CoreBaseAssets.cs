...
namespace Engine
{
    public partial class Core 
    {
        ...
        private void LoadBaseAssets()
        {
            ...
            Environments.Environment night_env = new("standard_night", new Vector4( 0.7f, 0.5f, 0.14f, 1f), 160f, new Vector4(0.5f,0.5f,0.5f,0.2f), skybox_tex_night);
            ...
            // Daynight cycles
            AssetLoader.EnvironmentAssetLoad(new Environments.DayNightCycle("standard_daynight", dawn_env, day_env, dusk_env, night_env), AssetLoader.AssetSource.engine); 
