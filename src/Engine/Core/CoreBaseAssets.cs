...
namespace Engine
{
    public partial class Core
    {
        ...
        private void LoadBaseAssets()
        {
            ...
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            // Environment
            EnvironmentData dawn_env = new("standard_dawn", new Vector4(0.25f, 0.46f, 0.79f, 1f), 270f, new Vector4(0.9f, 0.85f, 0.85f, 0.9f), skybox_tex_dawn);
            EnvironmentData day_env = new("standard_day", new Vector4(0.25f, 0.46f, 0.79f, 1f), 300f, new Vector4(1f, 0.95f, 0.95f, 1f), skybox_tex_day);
            EnvironmentData dusk_env = new("standard_dusk", new Vector4(0.40f, 0.45f, 0.28f, 1f), 220f, new Vector4(1f, 1f, 0.85f, 0.9f), skybox_tex_dusk);
            EnvironmentData night_env = new("standard_night", new Vector4(0.7f, 0.5f, 0.14f, 1f), 160f, new Vector4(0.5f, 0.5f, 0.5f, 0.3f), skybox_tex_night);
            EnvironmentData rain_day_env = new("standard_rain_day", new Vector4(0.35f, 0.40f, 0.54f, 1f), 140f, new Vector4(0.95f, 1f, 0.95f, 0.8f), skybox_tex_dayrain);
            EnvironmentData rain_night_env = new("standard_rain_night", new Vector4(0.13f, 0.13f, 0.13f, 1f), 120f, new Vector4(0.4f, 0.6f, 0.5f, 0.25f), skybox_tex_nightrain);
