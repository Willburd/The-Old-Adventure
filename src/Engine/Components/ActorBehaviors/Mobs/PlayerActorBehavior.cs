...
namespace EntComponents.ActorBehavior
{
    public class PlayerActorBehavior : EntComponent
    {
        ...
        protected override uint HandleAssetLoad()
        {
            ...
            // Textures
            TextureData sign_wood = AssetLoader.TextureAssetLoad("/Textures/sign_wood.png", Silk.NET.OpenGL.TextureTarget.Texture2D);
            TextureData sign_face = AssetLoader.TextureAssetLoad("/Textures/sign_face.png", Silk.NET.OpenGL.TextureTarget.Texture2D);
            ...
            // Model
            AssetLoader.ModelAssetLoad("/Models/sign.fbx");
