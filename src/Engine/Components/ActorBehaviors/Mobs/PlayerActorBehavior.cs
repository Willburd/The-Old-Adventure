...
namespace EntComponents.ActorBehavior
{
    public class PlayerActorBehavior : EntComponent
    {
        ...
        protected override uint HandleAssetLoad()
        {
            ...
            // Textures
            TextureData sign_wood = AssetLoader.TextureAssetLoad(AssetLoader.AssetDirectoryAdventure + "/Textures/sign_wood.png", Silk.NET.OpenGL.TextureTarget.Texture2D);
            TextureData sign_face = AssetLoader.TextureAssetLoad(AssetLoader.AssetDirectoryAdventure + "/Textures/sign_face.png", Silk.NET.OpenGL.TextureTarget.Texture2D);
            ...
            // Model
            AssetLoader.ModelAssetLoad(AssetLoader.AssetDirectoryAdventure + "/Models/sign.fbx");
        ...
        protected override uint HandleCreate()
        {
            ...
            collision.SetShape(new Engine.ColliderShapes.CylinderCol(0.8f, 0.25f));
