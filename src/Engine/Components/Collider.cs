...
namespace EntComponents
{
    ...
    /// </summary>
    public class Collider(Engine.Entity host_entity) : EntComponent(host_entity)
    {
        ...
        {
            if(debug_vis) Host.RegisterSignal(Engine.Core.Signals.render_standard, this);
        }
        public override void UnregisterSignals()
        {
            if(debug_vis) Host.UnregisterSignal(Engine.Core.Signals.render_standard, this);
        }
