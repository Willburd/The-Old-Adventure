...
namespace EntComponents.ActorBehavior
{
    public class TestActorBehavior(Entity host_entity) : EntComponent(host_entity)
    {
        ...
        protected override uint HandleAssetLoad()
        {
            ...
            // Textures
            TextureData sign_wood = AssetLoader.TextureAssetLoad("sign_wood", "/Textures/sign_wood.png", Silk.NET.OpenGL.TextureTarget.Texture2D);
            TextureData sign_face = AssetLoader.TextureAssetLoad("sign_face", "/Textures/sign_face.png", Silk.NET.OpenGL.TextureTarget.Texture2D);
            ...
            // Model
            AssetLoader.ModelAssetLoad("sign", "/Models/sign.fbx");
